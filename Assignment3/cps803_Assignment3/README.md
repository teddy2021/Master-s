...
8. Once you are done with all the code changes, create a `submission.zip`.
  - You must upload this `submission.zip` to D2L along with your assignment's written report.
